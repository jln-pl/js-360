...
/***/ function(module, exports, __webpack_require__) {
	...
	var _coreCore = __webpack_require__(1);

	var _coreCore2 = _interopRequireDefault(_coreCore);

	var JS360 = { generate360view: _coreCore2['default'] };

	(function (win) {
	    win.JS360 = JS360;
	})(window);

	exports['default'] = JS360;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = generate360view;

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }

	var _handlersHandler = __webpack_require__(2);

	var _handlersHandler2 = _interopRequireDefault(_handlersHandler);
	...
	function generate360view(containerId) {
	    var container = document.getElementById(containerId);
	    var handler = (0, _handlersHandler2['default'])(container);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getHandler(container) {
	    var start = _rx.Observable.merge(_rx.Observable.fromEvent(container, 'mousedown'), _rx.Observable.fromEvent(container, 'touchstart'))['do'](preventDefault)['do'](setStartingPosition);

	    var end = _rx.Observable.merge(_rx.Observable.fromEvent(container, 'mouseup'), _rx.Observable.fromEvent(container, 'touchend'))['do'](preventDefault)['do'](clearPreviousPosition);

	    var move = _rx.Observable.merge(_rx.Observable.fromEvent(container, 'mousemove'), _rx.Observable.fromEvent(container, 'touchmove'))['do'](preventDefault).map(calculatePositions).filter(probe)['do'](setStartingPosition).map(getActualPosition).takeUntil(end);

	    return start.flatMap(move).map(counterMapper);
	}
